...
$sql = "SELECT visit.visit_date, visit.visit_time, patient.Firstname AS PatientFirstName, patient.Surname AS PatientSurname, doctor.Firstname AS DocFirstname, doctor.Surname AS DocSurname, doctor.Specialism FROM visit
